RSpec.describe "Testing uninstall app", :type => :request do
  ...
  # gex_env=main user_name=kennedi-abernathy cluster_id=535 cluster_uid=3171573504674961 rspec spec/features/apps/uninstall_datameer_spec.rb
  describe "uninstall app(datameer)" do
    ...
    before(:all) do
      ...
      cluster_name =  ENV['cluster_name'] || 'broad-ophiuchus'
