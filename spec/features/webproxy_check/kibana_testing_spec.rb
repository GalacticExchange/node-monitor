...
RSpec.describe "Testing main functionality ", :type => :request do
  ...
  # Need to specify environment variable 'browser' in order to open Chrome browser, need installed aws node
  describe "web proxy testing" do
    ...
    it "current user login in ClusterGX" do
      ...
      visit('http://p10235.webproxy.devgex.net/app/kibana#?_g=()')
      sleep 3
